...
bool VulkanRenderEngine::init_render_resources() {
    if (!init_pipelines()) return false;
    return true;
}

void VulkanRenderEngine::cleanup_render_resources() {
...
bool VulkanRenderEngine::init_pipelines() {
...
void VulkanRenderEngine::upload_mesh(Mesh& mesh) {
