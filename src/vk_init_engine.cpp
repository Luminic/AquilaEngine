...
VulkanInitializationEngine::VulkanInitializationEngine() {}

VulkanInitializationEngine::~VulkanInitializationEngine() {
    cleanup(); // Just in case
}

VulkanInitializationEngine::InitializationState VulkanInitializationEngine::init() {
...
void VulkanInitializationEngine::cleanup() {
...
VulkanInitializationEngine::InitializationState VulkanInitializationEngine::get_initialization_state() {
    return initialization_state;
}

bool VulkanInitializationEngine::init_vulkan_resources() {
    // Get extensions
...
void VulkanInitializationEngine::cleanup_vulkan_resources() {
...
bool VulkanInitializationEngine::init_swapchain_resources() {
...
void VulkanInitializationEngine::cleanup_swapchain_resources() {
    // Make sure everything has finished
    if (device)
        CHECK_VK_RESULT(device.waitIdle(), "Failed to wait for device to finish all tasks for cleanup");
...
bool VulkanInitializationEngine::init_render_resources() {return true;}
...
bool VulkanInitializationEngine::choose_surface_format() {
...
bool VulkanInitializationEngine::init_default_renderpass() {
...
bool VulkanInitializationEngine::init_command_buffers() {
...
bool VulkanInitializationEngine::init_swapchain() {
    vk_init::SwapChainSupportDetails& sw_ch_support = gpu_properties.sw_ch_support;
...
bool VulkanInitializationEngine::init_framebuffers() {
...
bool VulkanInitializationEngine::init_sync_structures() {
